function clearm() {
    mc.runcmd('tellraw @a[tag=!UA] {"rawtext" :[{"text" :"§aОчистка мобов и предметов через §c1§3 минуту"}]}');
	mc.runcmd('tellraw @a[tag=UA] {"rawtext" :[{"text" :"§aОчищення мобів та предметів через §c1§3 хвилину"}]}');
	mc.runcmd('playsound mob.irongolem.death @a');
    setTimeout("mc.runcmd('h')",60000);
	setTimeout("mc.runcmd('hh')",60000);
	setTimeout("mc.runcmd('playsound note.banjo @a')",60000);
	setTimeout("mc.runcmd('title @a actionbar §l§c12§33')",60000);
	setTimeout("mc.runcmd('hhh')",62000);
	setTimeout("mc.runcmd('hhhh')",62000);
	setTimeout("mc.runcmd('playsound note.banjo @a')",62000);
	setTimeout("mc.runcmd('title @a actionbar §l§c1§32§c3')",62000);
	setTimeout("mc.runcmd('hhhhh')",64000);
	setTimeout("mc.runcmd('hhhhhh')",64000);
	...
	setTimeout("mc.runcmd('§eУдаление мобов прошло успешно!')",66000);
};
function clearmob() {
...
function h() {
    mc.runcmd('tellraw @a[tag=!UA] {"rawtext" :[{"text" :"§aОчистка мобов и предметов через §43"}]}')
};
function hh() {
    mc.runcmd('tellraw @a[tag=UA] {"rawtext" :[{"text" :"§aОчищення мобів та предметів через §43"}]}')
};
function hhh() {
    mc.runcmd('tellraw @a[tag=!UA] {"rawtext" :[{"text" :"§aОчистка мобов и предметов через §42"}]}')
};
function hhhh() {
    mc.runcmd('tellraw @a[tag=UA] {"rawtext" :[{"text" :"§aОчищення мобів та предметів через §42"}]}')
};
function hhhhh() {
    mc.runcmd('tellraw @a[tag=!UA] {"rawtext" :[{"text" :"§aОчистка мобов и предметов через §41"}]}')
};
function hhhhhh() {
    mc.runcmd('tellraw @a[tag=UA] {"rawtext" :[{"text" :"§aОчищення мобів та предметів через §41"}]}')
};
...
mc.regConsoleCmd('h', 'h', h);
mc.regConsoleCmd('hh', 'hh', hh);
mc.regConsoleCmd('hhh', 'hhh', hhh);
mc.regConsoleCmd('hhhh', 'hhhh', hhhh);
mc.regConsoleCmd('hhhhh', 'hhhhh', hhhhh);
mc.regConsoleCmd('hhhhhh', 'hhhhhh', hhhhhh);